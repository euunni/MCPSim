...
void ConfigParameters::Reset() {
    diff_pot = m = x0 = x1 = x2 = x3 = x4 = c_e = 0.f;
    pas = dia = limite = E0 = Resistance = q = 0.f;
    alpha1 = alpha2 = gap_pot1 = gap_pot2 = 0.f;
...
void ConfigParameters::LoadFromConfig() {
    ...
    q = config.get("q");
    alpha1 = config.get("alpha1");
    alpha2 = config.get("alpha2");
    gap_pot1 = config.get("gap_pot1");
    gap_pot2 = config.get("gap_pot2");
