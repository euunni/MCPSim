...
public:
    ...
    static double Point_de_contact2(const Matrix3x3& Mat, int n, double cts);
    static Matrix3x3 Recuperation(const Matrix3x3& Mat);
    static Matrix3x3 Transporter1(const Matrix3x3& Mat, double t, double cts);
    static Matrix3x3 Transporter2(const Matrix3x3& Mat, double t, double cts);
    static void ajouter_element_trie(std::vector<Matrix3x3>& liste, const Matrix3x3& element);
    static bool Erreur(const Matrix3x3& Mat, int n);
    ...
    static std::vector<ElectronProcess> emi_sec(const Matrix3x3& Mat, int n);
...
private:
    ...
    static double alpha;      // channel slope
